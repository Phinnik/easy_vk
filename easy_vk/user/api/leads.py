...
class Leads(BaseCategory):
    ...
    def check_user(self, lead_id: int = None, test_result: int = None, test_mode: bool = None, auto_start: bool = None, age: int = None, country: str = None) -> response_models.LeadsCheckUserModel:
        """
        ...
        param_aliases = []
        response_type = response_models.LeadsCheckUserModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def complete(self, vk_sid: str = None, secret: str = None, comment: str = None) -> response_models.LeadsCompleteModel:
        """
        ...
        param_aliases = []
        response_type = response_models.LeadsCompleteModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_stats(self, lead_id: int = None, secret: str = None, date_start: str = None, date_end: str = None) -> response_models.LeadsGetStatsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.LeadsGetStatsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_users(self, offer_id: int = None, secret: str = None, offset: int = None, count: int = None, status: int = None, reverse: bool = None) -> response_models.LeadsGetUsersModel:
        """
        ...
        param_aliases = []
        response_type = response_models.LeadsGetUsersModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def metric_hit(self, data: str = None) -> response_models.LeadsMetricHitModel:
        """
        ...
        param_aliases = []
        response_type = response_models.LeadsMetricHitModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def start(self, lead_id: int = None, secret: str = None, uid: int = None, aid: int = None, test_mode: bool = None, force: bool = None) -> response_models.LeadsStartModel:
        """
        ...
        param_aliases = []
        response_type = response_models.LeadsStartModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
