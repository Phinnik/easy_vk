...
class Likes(BaseCategory):
    ...
    def add(self, type_: Union[objects.LikesType, str] = None, owner_id: int = None, item_id: int = None, access_key: str = None) -> response_models.LikesAddModel:
        """
        ...
        response_type = response_models.LikesAddModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def delete(self, type_: Union[objects.LikesType, str] = None, owner_id: int = None, item_id: int = None, access_key: str = None) -> response_models.LikesDeleteModel:
        """
        ...
        param_aliases = [('type_', 'type')]
        response_type = response_models.LikesDeleteModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_list(self, type_: Union[objects.LikesType, str] = None, owner_id: int = None, item_id: int = None, page_url: str = None, filter_: str = None, friends_only: int = None, extended: bool = None, offset: int = None, count: int = None, skip_own: bool = None) -> response_models.LikesGetListModel:
        """
        ...
        response_type = response_models.LikesGetListModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def is_liked(self, user_id: int = None, type_: Union[objects.LikesType, str] = None, owner_id: int = None, item_id: int = None) -> response_models.LikesIsLikedModel:
        """
        ...
        param_aliases = [('type_', 'type')]
        response_type = response_models.LikesIsLikedModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
