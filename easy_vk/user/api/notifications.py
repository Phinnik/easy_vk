...
class Notifications(BaseCategory):
    ...
    def get(self, count: int = None, start_from: str = None, filters: List[str] = None, start_time: int = None, end_time: int = None) -> response_models.NotificationsGetModel:
        """
        ...
        param_aliases = []
        response_type = response_models.NotificationsGetModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def mark_as_viewed(self) -> response_models.NotificationsMarkAsViewedModel:
        """
        ...
        param_aliases = []
        response_type = response_models.NotificationsMarkAsViewedModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def send_message(self, user_ids: List[int] = None, message: str = None, fragment: str = None, group_id: int = None, random_id: int = None) -> response_models.NotificationsSendMessageModel:
        """
        :param user_ids: 
        :param message: 
        :param fragment: 
        ...
        param_aliases = []
        response_type = response_models.NotificationsSendMessageModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
