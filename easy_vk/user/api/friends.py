...
class Friends(BaseCategory):
    ...
    def add(self, user_id: int = None, text: str = None, follow: bool = None) -> response_models.FriendsAddModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsAddModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def add_list(self, name: str = None, user_ids: List[int] = None) -> response_models.FriendsAddListModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsAddListModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def are_friends(self, user_ids: List[int] = None, need_sign: bool = None, extended: bool = None) -> response_models.FriendsAreFriendsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsAreFriendsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def delete(self, user_id: int = None) -> response_models.FriendsDeleteModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsDeleteModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def delete_all_requests(self) -> response_models.FriendsDeleteAllRequestsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsDeleteAllRequestsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def delete_list(self, list_id: int = None) -> response_models.FriendsDeleteListModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsDeleteListModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def edit(self, user_id: int = None, list_ids: List[int] = None) -> response_models.FriendsEditModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsEditModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def edit_list(self, name: str = None, list_id: int = None, user_ids: List[int] = None, add_user_ids: List[int] = None, delete_user_ids: List[int] = None) -> response_models.FriendsEditListModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsEditListModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get(self, user_id: int = None, order: str = None, list_id: int = None, count: int = None, offset: int = None, fields: List[Union[objects.UsersFields, str]] = None, name_case: str = None, ref: str = None) -> response_models.FriendsGetModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_app_users(self) -> response_models.FriendsGetAppUsersModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetAppUsersModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_by_phones(self, phones: List[str] = None, fields: List[Union[objects.UsersFields, str]] = None) -> response_models.FriendsGetByPhonesModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetByPhonesModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_lists(self, user_id: int = None, return_system: bool = None) -> response_models.FriendsGetListsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetListsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_mutual(self, source_uid: int = None, target_uid: int = None, target_uids: List[int] = None, order: str = None, count: int = None, offset: int = None) -> response_models.FriendsGetMutualModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetMutualModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_online(self, user_id: int = None, list_id: int = None, online_mobile: bool = None, order: str = None, count: int = None, offset: int = None) -> response_models.FriendsGetOnlineModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetOnlineModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_recent(self, count: int = None) -> response_models.FriendsGetRecentModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetRecentModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_requests(self, offset: int = None, count: int = None, extended: bool = None, need_mutual: bool = None, out: bool = None, sort: int = None, need_viewed: bool = None, suggested: bool = None, ref: str = None, fields: List[Union[objects.UsersFields, str]] = None) -> response_models.FriendsGetRequestsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsGetRequestsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_suggestions(self, filter_: List[str] = None, count: int = None, offset: int = None, fields: List[Union[objects.UsersFields, str]] = None, name_case: str = None) -> response_models.FriendsGetSuggestionsModel:
        """
        ...
        response_type = response_models.FriendsGetSuggestionsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def search(self, user_id: int = None, q: str = None, fields: List[Union[objects.UsersFields, str]] = None, name_case: str = None, offset: int = None, count: int = None) -> response_models.FriendsSearchModel:
        """
        ...
        param_aliases = []
        response_type = response_models.FriendsSearchModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
