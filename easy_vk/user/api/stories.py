...
class Stories(BaseCategory):
    ...
    def ban_owner(self, owners_ids: List[int] = None) -> responses.BaseOk:
        """
    ...
    def get_banned(self, extended: bool = None, fields: List[Union[objects.BaseUserGroupFields, str]] = None) -> Union[responses.StoriesGetBanned, responses.StoriesGetBannedExtended]:
        """
        ...
        param_aliases = []
        if not extended:
            response_type = responses.StoriesGetBanned
        else:
            response_type = responses.StoriesGetBannedExtended
        return self._call(method_name, method_parameters, param_aliases, response_type)
    ...
    def search(self, q: str = None, place_id: int = None, latitude: float = None, longitude: float = None, radius: int = None, mentioned_id: int = None, count: int = None, extended: bool = None, fields: List[str] = None) -> responses.StoriesGetV5113:
        """
        :param q: 
        :param place_id: 
        :param latitude: 
    ...
    def unban_owner(self, owners_ids: List[int] = None) -> responses.BaseOk:
        """
