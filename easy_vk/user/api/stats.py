...
class Stats(BaseCategory):
    ...
    def get(self, group_id: int = None, app_id: int = None, timestamp_from: int = None, timestamp_to: int = None, interval: str = None, intervals_count: int = None, filters: List[str] = None, stats_groups: List[str] = None, extended: bool = None) -> response_models.StatsGetModel:
        """
        ...
        param_aliases = []
        response_type = response_models.StatsGetModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_post_reach(self, owner_id: str = None, post_ids: List[int] = None) -> response_models.StatsGetPostReachModel:
        """
        ...
        param_aliases = []
        response_type = response_models.StatsGetPostReachModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def track_visitor(self, id_: str = None) -> response_models.StatsTrackVisitorModel:
        """
        :param id_: 
        """
        ...
        response_type = response_models.StatsTrackVisitorModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
