...
class Utils(BaseCategory):
    ...
    def delete_from_last_shortened(self, key: str = None) -> responses.BaseOk:
        """
    ...
    def get_last_shortened_links(self, count: int = None, offset: int = None) -> responses.UtilsGetLastShortenedLinks:
        """
