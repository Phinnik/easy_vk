...
class Utils(BaseCategory):
    ...
    def delete_from_last_shortened(self, key: str = None) -> response_models.UtilsDeleteFromLastShortenedModel:
        """
        ...
        param_aliases = []
        response_type = response_models.UtilsDeleteFromLastShortenedModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_last_shortened_links(self, count: int = None, offset: int = None) -> response_models.UtilsGetLastShortenedLinksModel:
        """
        ...
        param_aliases = []
        response_type = response_models.UtilsGetLastShortenedLinksModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
