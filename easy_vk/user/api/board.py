...
class Board(BaseCategory):
    ...
    def add_topic(self, group_id: int = None, title: str = None, text: str = None, from_group: bool = None, attachments: List[str] = None) -> response_models.BoardAddTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardAddTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def close_topic(self, group_id: int = None, topic_id: int = None) -> response_models.BoardCloseTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardCloseTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def create_comment(self, group_id: int = None, topic_id: int = None, message: str = None, attachments: List[str] = None, from_group: bool = None, sticker_id: int = None, guid: str = None) -> response_models.BoardCreateCommentModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardCreateCommentModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
    ...
    def delete_topic(self, group_id: int = None, topic_id: int = None) -> response_models.BoardDeleteTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardDeleteTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def edit_comment(self, group_id: int = None, topic_id: int = None, comment_id: int = None, message: str = None, attachments: List[str] = None) -> response_models.BoardEditCommentModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardEditCommentModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def edit_topic(self, group_id: int = None, topic_id: int = None, title: str = None) -> response_models.BoardEditTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardEditTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def fix_topic(self, group_id: int = None, topic_id: int = None) -> response_models.BoardFixTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardFixTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_comments(self, group_id: int = None, topic_id: int = None, need_likes: bool = None, start_comment_id: int = None, offset: int = None, count: int = None, extended: bool = None, sort: str = None) -> response_models.BoardGetCommentsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardGetCommentsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_topics(self, group_id: int = None, topic_ids: List[int] = None, order: int = None, offset: int = None, count: int = None, extended: bool = None, preview: int = None, preview_length: int = None) -> response_models.BoardGetTopicsModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardGetTopicsModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def open_topic(self, group_id: int = None, topic_id: int = None) -> response_models.BoardOpenTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardOpenTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
    ...
    def unfix_topic(self, group_id: int = None, topic_id: int = None) -> response_models.BoardUnfixTopicModel:
        """
        ...
        param_aliases = []
        response_type = response_models.BoardUnfixTopicModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
