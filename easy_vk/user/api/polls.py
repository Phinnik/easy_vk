...
class Polls(BaseCategory):
    ...
    def add_vote(self, owner_id: int = None, poll_id: int = None, answer_ids: List[int] = None, is_board: bool = None) -> response_models.PollsAddVoteModel:
        """
        ...
        param_aliases = []
        response_type = response_models.PollsAddVoteModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def create(self, question: str = None, is_anonymous: bool = None, is_multiple: bool = None, end_date: int = None, owner_id: int = None, add_answers: str = None, photo_id: int = None, background_id: str = None, disable_unvote: bool = None) -> response_models.PollsCreateModel:
        """
        ...
        param_aliases = []
        response_type = response_models.PollsCreateModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def delete_vote(self, owner_id: int = None, poll_id: int = None, answer_id: int = None, is_board: bool = None) -> response_models.PollsDeleteVoteModel:
        """
        ...
        param_aliases = []
        response_type = response_models.PollsDeleteVoteModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def edit(self, owner_id: int = None, poll_id: int = None, question: str = None, add_answers: str = None, edit_answers: str = None, delete_answers: str = None, end_date: int = None, photo_id: int = None, background_id: str = None) -> response_models.PollsEditModel:
        """
        Edits created polls
        ...
        param_aliases = []
        response_type = response_models.PollsEditModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_by_id(self, owner_id: int = None, is_board: bool = None, poll_id: int = None, extended: bool = None, friends_count: int = None, fields: List[str] = None, name_case: str = None) -> response_models.PollsGetByIdModel:
        """
        ...
        param_aliases = []
        response_type = response_models.PollsGetByIdModel
        return self._call(method_name, method_parameters, param_aliases, response_type)

    def get_voters(self, owner_id: int = None, poll_id: int = None, answer_ids: List[int] = None, is_board: bool = None, friends_only: bool = None, offset: int = None, count: int = None, fields: List[Union[objects.UsersFields, str]] = None, name_case: str = None) -> response_models.PollsGetVotersModel:
        """
        ...
        param_aliases = []
        response_type = response_models.PollsGetVotersModel
        return self._call(method_name, method_parameters, param_aliases, response_type)
