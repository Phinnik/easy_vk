...
class Messages(BaseCategory):
    ...
    def add_chat_user(self, chat_id: int, user_id: Optional[int] = None, visible_messages_count: Optional[int] = None) -> responses.BaseOk:
        """
    ...
    def allow_messages_from_group(self, group_id: int, key: Optional[str] = None) -> responses.BaseOk:
        """
    ...
    def deny_messages_from_group(self, group_id: int) -> responses.BaseOk:
        """
    ...
    def get_chat_preview(self, peer_id: Optional[int] = None, link: Optional[str] = None, fields: Optional[List[Union[objects.UsersFields, str]]] = None) -> responses.MessagesGetChatPreview:
        """
        :param peer_id:
    ...
    def get_last_activity(self, user_id: int) -> responses.MessagesGetLastActivity:
        """
    ...
    def join_chat_by_invite_link(self, link: str) -> responses.MessagesJoinChatByInviteLink:
        """
        :param link: Invitation link.
        """
    ...
    def mark_as_important(self, message_ids: Optional[List[int]] = None, important: Optional[int] = None) -> responses.MessagesMarkAsImportant:
        """
