...
class Groups(BaseCategory):
    ...
    def add_link(self, group_id: int, link: str, text: Optional[str] = None) -> responses.GroupsAddLink:
        """
    ...
    def approve_request(self, group_id: int, user_id: int) -> responses.BaseOk:
        """
    ...
    def ban(self, group_id: int, owner_id: Optional[int] = None, end_date: Optional[int] = None, reason: Optional[int] = None, comment: Optional[str] = None, comment_visible: Optional[bool] = None) -> responses.BaseOk:
        """
        :param group_id:
        :param owner_id:
        :param end_date:
    ...
    def create(self, title: str, description: Optional[str] = None, type_: Optional[str] = None, public_category: Optional[int] = None, subtype: Optional[int] = None) -> responses.GroupsCreate:
        """
    ...
    def delete_link(self, group_id: int, link_id: int) -> responses.BaseOk:
        """
    ...
    def edit_link(self, group_id: int, link_id: int, text: Optional[str] = None) -> responses.BaseOk:
        """
    ...
    def edit_manager(self, group_id: int, user_id: int, role: Optional[str] = None, is_contact: Optional[bool] = None, contact_position: Optional[str] = None, contact_phone: Optional[str] = None, contact_email: Optional[str] = None) -> responses.BaseOk:
        """
    ...
    @overload
    def get(self, user_id: Optional[int] = None, extended: None = None, filter_: Optional[List[Union[objects.GroupsFilter, str]]] = None, fields: Optional[List[Union[objects.GroupsFields, str]]] = None, offset: Optional[int] = None, count: Optional[int] = None) -> responses.GroupsGet: ...
    @overload
    def get(self, extended: bool, user_id: Optional[int] = None, filter_: Optional[List[Union[objects.GroupsFilter, str]]] = None, fields: Optional[List[Union[objects.GroupsFields, str]]] = None, offset: Optional[int] = None, count: Optional[int] = None) -> responses.GroupsGetExtended: ...
    def get(self, user_id: Optional[int] = None, extended: Optional[bool] = None, filter_: Optional[List[Union[objects.GroupsFilter, str]]] = None, fields: Optional[List[Union[objects.GroupsFields, str]]] = None, offset: Optional[int] = None, count: Optional[int] = None):
        """
    ...
    def get_addresses(self, group_id: int, address_ids: Optional[List[int]] = None, latitude: Optional[float] = None, longitude: Optional[float] = None, offset: Optional[int] = None, count: Optional[int] = None, fields: Optional[List[Union[objects.AddressesFields, str]]] = None) -> responses.GroupsGetAddresses:
        """
    ...
    def get_catalog(self, category_id: Optional[int] = None, subcategory_id: Optional[int] = None) -> responses.GroupsGetCatalog:
        """
    ...
    @overload
    def get_catalog_info(self, extended: None = None, subcategories: Optional[bool] = None) -> responses.GroupsGetCatalogInfo: ...
    @overload
    def get_catalog_info(self, extended: bool, subcategories: Optional[bool] = None) -> responses.GroupsGetCatalogInfoExtended: ...
    def get_catalog_info(self, extended: Optional[bool] = None, subcategories: Optional[bool] = None):
        """
    ...
    def get_invited_users(self, group_id: int, offset: Optional[int] = None, count: Optional[int] = None, fields: Optional[List[Union[objects.UsersFields, str]]] = None, name_case: Optional[str] = None) -> responses.GroupsGetInvitedUsers:
        """
    ...
    @overload
    def get_invites(self, offset: Optional[int] = None, count: Optional[int] = None, extended: None = None) -> responses.GroupsGetInvites: ...
    @overload
    def get_invites(self, extended: bool, offset: Optional[int] = None, count: Optional[int] = None) -> responses.GroupsGetInvitesExtended: ...
    def get_invites(self, offset: Optional[int] = None, count: Optional[int] = None, extended: Optional[bool] = None):
        """
    ...
    @overload
    def get_requests(self, group_id: int, offset: Optional[int] = None, count: Optional[int] = None, fields: None = None) -> responses.GroupsGetRequests: ...
    @overload
    def get_requests(self, group_id: int, fields: List[Union[objects.UsersFields, str]], offset: Optional[int] = None, count: Optional[int] = None) -> responses.GroupsGetRequestsFields: ...
    def get_requests(self, group_id: int, offset: Optional[int] = None, count: Optional[int] = None, fields: Optional[List[Union[objects.UsersFields, str]]] = None):
        """
    ...
    def get_settings(self, group_id: int) -> responses.GroupsGetSettings:
        """
    ...
    def invite(self, group_id: int, user_id: int) -> responses.BaseOk:
        """
    ...
    def join(self, group_id: Optional[int] = None, not_sure: Optional[str] = None) -> responses.BaseOk:
        """
    ...
    def leave(self, group_id: int) -> responses.BaseOk:
        """
    ...
    def remove_user(self, group_id: int, user_id: int) -> responses.BaseOk:
        """
    ...
    def reorder_link(self, group_id: int, link_id: int, after: Optional[int] = None) -> responses.BaseOk:
        """
    ...
    def search(self, q: str, type_: Optional[str] = None, country_id: Optional[int] = None, city_id: Optional[int] = None, future: Optional[bool] = None, market: Optional[bool] = None, sort: Optional[int] = None, offset: Optional[int] = None, count: Optional[int] = None) -> responses.GroupsSearch:
        """
    ...
    def unban(self, group_id: int, owner_id: Optional[int] = None) -> responses.BaseOk:
        """
        :param group_id:
        :param owner_id:
        """
